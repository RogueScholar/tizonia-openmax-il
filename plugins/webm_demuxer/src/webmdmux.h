...
#define ARATELIA_WEBM_DEMUXER_WEBM_PORT_MIN_BUF_COUNT 4
#define ARATELIA_WEBM_DEMUXER_WEBM_PORT_MIN_BUF_SIZE 1024 * 32
...
#define ARATELIA_WEBM_DEMUXER_AUDIO_PORT_MIN_BUF_SIZE 1024 * 8
...
#define ARATELIA_WEBM_DEMUXER_VIDEO_PORT_MIN_BUF_SIZE 1024 * 16
