...
#define ARATELIA_PCM_RENDERER_COMPONENT_NAME \
...
#define ARATELIA_PCM_RENDERER_PULSEAUDIO_APP_NAME \
  "Tizonia PulseAudio PCM Renderer"
#define ARATELIA_PCM_RENDERER_PULSEAUDIO_STREAM_NAME \
  "Tizonia Pulseadio PCM renderer (playback stream)"
