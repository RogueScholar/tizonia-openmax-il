...
OMX_ComponentInit (OMX_HANDLETYPE ap_hdl)
{
  ...
  strcpy ((OMX_STRING) audio_role.role, ARATELIA_INPROC_READER_AUDIO_ROLE);
  ...
  strcpy ((OMX_STRING) video_role.role, ARATELIA_INPROC_READER_VIDEO_ROLE);
  ...
  strcpy ((OMX_STRING) image_role.role, ARATELIA_INPROC_READER_IMAGE_ROLE);
  ...
  strcpy ((OMX_STRING) other_role.role, ARATELIA_INPROC_READER_OTHER_ROLE);
