...
#include "cc_plexcfgport_decls.h"

#ifdef TIZ_LOG_CATEGORY_NAME
#undef TIZ_LOG_CATEGORY_NAME
#define TIZ_LOG_CATEGORY_NAME "tiz.chromecast_renderer.cfgport.plex"
#endif

/*
 * cc_plexcfgport class
 */
                              ...
                              OMX_INDEXTYPE a_index, OMX_PTR ap_struct)
{
    ...
    else
    {
        ...
        rc = super_GetParameter (typeOf (ap_obj, "cc_plexcfgport"), ap_obj,
...
/*
 * cc_plex_cfgport_class
 */

static void *
cc_plex_cfgport_class_ctor (void * ap_obj, va_list * app)
{
    /* NOTE: Class methods might be added in the future. None for now. */
    return super_ctor (typeOf (ap_obj, "cc_plexcfgport_class"), ap_obj, app);
}
...
void *
cc_plex_cfgport_class_init (void * ap_tos, void * ap_hdl)
{
    void * cc_cfgport = tiz_get_type (ap_hdl, "cc_cfgport");
    void * cc_plexcfgport_class
        = factory_new (classOf (cc_cfgport), "cc_plexcfgport_class",
                       classOf (cc_cfgport), sizeof (cc_plex_cfgport_class_t),
                       ap_tos, ap_hdl, ctor, cc_plex_cfgport_class_ctor, 0);
    return cc_plexcfgport_class;
}
...
cc_plex_cfgport_init (void * ap_tos, void * ap_hdl)
{
    ...
    void * cc_plexcfgport = factory_new
                            ...
                            (cc_plexcfgport_class, "cc_plexcfgport", cc_cfgport,
                             sizeof (cc_plex_cfgport_t),
                             /* TIZ_CLASS_COMMENT: class constructor */
                             ap_tos, ap_hdl,
                             /* TIZ_CLASS_COMMENT: class constructor */
                             ctor, cc_plex_cfgport_ctor,
                             /* TIZ_CLASS_COMMENT: class destructor */
                             dtor, cc_plex_cfgport_dtor,
                             /* TIZ_CLASS_COMMENT: */
                             tiz_api_GetParameter, cc_plex_cfgport_GetParameter,
                             /* TIZ_CLASS_COMMENT: */
                             tiz_api_SetParameter, cc_plex_cfgport_SetParameter,
                             /* TIZ_CLASS_COMMENT: stop value*/
                             0);

    return cc_plexcfgport;
}
