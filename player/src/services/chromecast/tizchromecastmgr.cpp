...
/**
 * @file   tizchromecastmgr.cpp
 * @author Juan A. Rubio <juan.rubio@aratelia.com>
 *
 * @brief  Manager implementation for the Chromecast rendering graph
 *
 */
...
#define TIZ_LOG_CATEGORY_NAME "tiz.play.chromecastmgr"
#endif
...
graphmgr::ops *graphmgr::chromecastmgr::do_init (
