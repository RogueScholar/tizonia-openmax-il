...
/**
 * @file   tiztuneingraphops.hpp
 * @author Juan A. Rubio <juan.rubio@aratelia.com>
 *
 * @brief  Tunein client graph actions / operations
 *
 *
 */
...
class tuneinops : public ops
{
public:
    tuneinops (graph *p_graph, const omx_comp_name_lst_t &comp_lst,
...
private:
    ...
    OMX_ERRORTYPE get_encoding_type_from_tunein_source ();
