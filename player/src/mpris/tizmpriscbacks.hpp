...
namespace tiz
{
  namespace control
  {
    ...
    public:
      mpris_callbacks (cback_func_t play, cback_func_t next,
                       cback_func_t previous, cback_func_t pause,
                       cback_func_t playpause, cback_func_t stop,
                       cback_func_t quit, cback_vol_func_t volume)
        : play_ (play),
          next_ (next),
          previous_ (previous),
          pause_ (pause),
