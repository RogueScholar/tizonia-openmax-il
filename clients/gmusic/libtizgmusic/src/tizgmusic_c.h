 ...
 * @return 0 on success
 */
int tiz_gmusic_play_playlist (tiz_gmusic_t *ap_gmusic,
 ...
 * @return 0 on success
 */
int tiz_gmusic_play_free_station (tiz_gmusic_t *ap_gmusic,
 ...
 *
 * @param ap_gmusic The gmusic handle.
 * @param ap_situation The situation name (e.g. working out, office radio)
 * @param ap_additional_keywords An additional search term to filter the
 * stations returned by the situation search.
 *
 * @return 0 on success
 */
