 ...
 */
#define OMX_TizoniaIndexParamBufferPreAnnouncementsMode \
  OMX_IndexVendorStartUnused + 1

#define OMX_TizoniaIndexParamHttpServer \
  OMX_IndexVendorStartUnused + 2 /**< reference: OMX_TIZONIA_HTTPSERVERTYPE */
#define OMX_TizoniaIndexParamIcecastMountpoint \
  OMX_IndexVendorStartUnused                   \
    + 3 /**< reference: OMX_TIZONIA_ICECASTMOUNTPOINTTYPE */
#define OMX_TizoniaIndexConfigIcecastMetadata \
  OMX_IndexVendorStartUnused                  \
    + 4 /**< reference: OMX_TIZONIA_ICECASTMETADATATYPE */
#define OMX_TizoniaIndexParamAudioOpus \
  OMX_IndexVendorStartUnused           \
    + 5 /**< reference: OMX_TIZONIA_AUDIO_PARAM_OPUSTYPE */
#define OMX_TizoniaIndexParamAudioFlac \
  OMX_IndexVendorStartUnused           \
    + 6 /**< reference: OMX_TIZONIA_AUDIO_PARAM_FLACTYPE */
#define OMX_TizoniaIndexParamAudioMp2 \
  OMX_IndexVendorStartUnused          \
    + 7 /**< reference: OMX_TIZONIA_AUDIO_PARAM_MP2TYPE */
#define OMX_TizoniaIndexParamAudioSpotifySession \
  OMX_IndexVendorStartUnused                     \
    + 8 /**< reference: OMX_TIZONIA_AUDIO_PARAM_SPOTIFYSESSIONTYPE */
#define OMX_TizoniaIndexParamAudioSpotifyPlaylist \
  OMX_IndexVendorStartUnused                      \
    + 9 /**< reference: OMX_TIZONIA_AUDIO_PARAM_SPOTIFYPLAYLISTTYPE */
#define OMX_TizoniaIndexParamAudioGmusicSession \
  OMX_IndexVendorStartUnused                    \
    + 10 /**< reference: OMX_TIZONIA_AUDIO_PARAM_GMUSICSESSIONTYPE */
#define OMX_TizoniaIndexParamAudioGmusicPlaylist \
  OMX_IndexVendorStartUnused                     \
    + 11 /**< reference: OMX_TIZONIA_AUDIO_PARAM_GMUSICPLAYLISTTYPE */
#define OMX_TizoniaIndexConfigPlaylistSkip \
  OMX_IndexVendorStartUnused               \
    + 12 /**< reference: OMX_TIZONIA_PLAYLISTSKIPTYPE */
#define OMX_TizoniaIndexParamAudioSoundCloudSession \
  OMX_IndexVendorStartUnused                        \
    + 13 /**< reference: OMX_TIZONIA_AUDIO_PARAM_SOUNDCLOUDSESSIONTYPE */
#define OMX_TizoniaIndexParamAudioSoundCloudPlaylist \
  OMX_IndexVendorStartUnused                         \
    + 14 /**< reference: OMX_TIZONIA_AUDIO_PARAM_SOUNDCLOUDPLAYLISTTYPE */
#define OMX_TizoniaIndexParamAudioTuneinSession \
  OMX_IndexVendorStartUnused                    \
    + 15 /**< reference: OMX_TIZONIA_AUDIO_PARAM_TUNEINSESSIONTYPE */
#define OMX_TizoniaIndexParamAudioTuneinPlaylist \
  OMX_IndexVendorStartUnused                     \
    + 16 /**< reference: OMX_TIZONIA_AUDIO_PARAM_TUNEINPLAYLISTTYPE */
#define OMX_TizoniaIndexParamAudioYoutubeSession \
  OMX_IndexVendorStartUnused                     \
    + 17 /**< reference: OMX_TIZONIA_AUDIO_PARAM_YOUTUBESESSIONTYPE */
#define OMX_TizoniaIndexParamAudioYoutubePlaylist \
  OMX_IndexVendorStartUnused                      \
    + 18 /**< reference: OMX_TIZONIA_AUDIO_PARAM_YOUTUBEPLAYLISTTYPE */
#define OMX_TizoniaIndexParamAudioDeezerSession \
  OMX_IndexVendorStartUnused                    \
    + 19 /**< reference: OMX_TIZONIA_AUDIO_PARAM_DEEZERSESSIONTYPE */
#define OMX_TizoniaIndexParamAudioDeezerPlaylist \
  OMX_IndexVendorStartUnused                     \
    + 20 /**< reference: OMX_TIZONIA_AUDIO_PARAM_DEEZERPLAYLISTTYPE */
#define OMX_TizoniaIndexParamChromecastSession \
  OMX_IndexVendorStartUnused                   \
    + 21 /**< reference: OMX_TIZONIA_PARAM_CHROMECASTSESSIONTYPE */
#define OMX_TizoniaIndexParamAudioPlexSession \
  OMX_IndexVendorStartUnused                  \
    + 22 /**< reference: OMX_TIZONIA_AUDIO_PARAM_PLEXSESSIONTYPE */
#define OMX_TizoniaIndexParamAudioPlexPlaylist \
  OMX_IndexVendorStartUnused                   \
    + 23 /**< reference: OMX_TIZONIA_AUDIO_PARAM_PLEXPLAYLISTTYPE */
#define OMX_TizoniaIndexParamStreamingBuffer \
  OMX_IndexVendorStartUnused                 \
    + 24 /**< reference: OMX_TIZONIA_STREAMINGBUFFERTYPE */
...
#define OMX_AUDIO_CodingOGA         \
  OMX_AUDIO_CodingVendorStartUnused \
    + 4 /**< this for audio in an ogg container */
#define OMX_AUDIO_CodingMP2 OMX_AUDIO_CodingVendorStartUnused + 5
#define OMX_AUDIO_CodingMP4         \
  OMX_AUDIO_CodingVendorStartUnused \
    + 6 /**< this for audio in a mp4 container */
#define OMX_AUDIO_CodingWEBM        \
  OMX_AUDIO_CodingVendorStartUnused \
    + 7 /**< this for audio in a webm container */
...
typedef struct OMX_TIZONIA_PLAYLISTSKIPTYPE
{
  ...
  OMX_VERSIONTYPE nVersion;
  OMX_S32
    nValue; /**< Can be a positive or a negative value. Wrap-around use cases are allowed. */
...
typedef struct OMX_TIZONIA_STREAMINGBUFFERTYPE
{
  ...
  OMX_U32
    nLowWaterMark; /**< A percentage of the total capacity, in the range 0-100. */
  OMX_U32
    nHighWaterMark; /**< A percentage of the total capacity, in the range 0-100. */
...
typedef struct OMX_TIZONIA_ICECASTMETADATATYPE
{
  ...
  OMX_U32 nPortIndex;
  OMX_U8 cStreamTitle
    [1]; /**< Max length is OMX_TIZONIA_MAX_SHOUTCAST_METADATA_SIZE */
...
typedef enum OMX_TIZONIA_AUDIO_OPUSSTREAMFORMATTYPE
{
  ...
  OMX_AUDIO_OPUSStreamFormatKhronosExtensions
  = 0x6F000000, /**< Reserved region for introducing Khronos Standard Extensions */
  OMX_AUDIO_OPUSStreamFormatVendorStartUnused
...
{
  OMX_AUDIO_MP2StreamFormatMP1Layer2
  = 0, /**< MP2 Audio MPEG 1 Layer 2 Streaxm format */
  OMX_AUDIO_MP2StreamFormatMP2Layer2, /**< MP2 Audio MPEG 2 Layer 2 Stream format */
  OMX_AUDIO_MP2StreamFormatKhronosExtensions
  = 0x6F000000, /**< Reserved region for introducing Khronos Standard Extensions */
  OMX_AUDIO_MP2StreamFormatVendorStartUnused
  = 0x7F000000, /**< Reserved region for introducing Vendor Extensions */
...
typedef struct OMX_TIZONIA_AUDIO_PARAM_MP2TYPE
{
  ...
  OMX_U32 nChannels;
  OMX_U32
    nBitRate; /**< 8, 16, 24, 40 and 144 kbit/s (MPEG-2 only), 32, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, 320 and 384 kbit/s (MPEG-1 and MPEG-2) */
  OMX_U32
    nSampleRate; /**< 16, 22.05 and 24 (MPEG-2 only), 32, 44.1 and 48 kHz (MPEG-1 and MPEG-2)*/
  OMX_AUDIO_CHANNELMODETYPE eChannelMode;
...
{
  OMX_AUDIO_SpotifyPlaylistTypeUnknown
  = 0,                                 /**< Playlist type unknown (Default). */
  ...
  OMX_AUDIO_SpotifyPlaylistTypeKhronosExtensions
  = 0x6F000000, /**< Reserved region for introducing Khronos Standard Extensions */
  OMX_AUDIO_SpotifyPlaylistTypeVendorStartUnused
  = 0x7F000000, /**< Reserved region for introducing Vendor Extensions */
...
{
  OMX_AUDIO_SpotifyConnectionUnknown
  = 0,                               /**< Connection type unknown (Default) */
  ...
  OMX_AUDIO_SpotifyConnectionKhronosExtensions
  = 0x6F000000, /**< Reserved region for introducing Khronos Standard Extensions */
  OMX_AUDIO_SpotifyConnectionVendorStartUnused
  = 0x7F000000, /**< Reserved region for introducing Vendor Extensions */
...
typedef enum OMX_TIZONIA_AUDIO_SPOTIFYBITRATETYPE
{
  ...
  OMX_AUDIO_SpotifyBitrateKhronosExtensions
  = 0x6F000000, /**< Reserved region for introducing Khronos Standard Extensions */
  OMX_AUDIO_SpotifyBitrateVendorStartUnused
  = 0x7F000000, /**< Reserved region for introducing Vendor Extensions */
...
typedef struct OMX_TIZONIA_AUDIO_PARAM_SPOTIFYSESSIONTYPE
{
  ...
  OMX_U8 cProxyServer
    [OMX_MAX_STRINGNAME_SIZE]; /**< Url to the proxy server that should be used. */
  ...
  OMX_TIZONIA_AUDIO_SPOTIFYBITRATETYPE
    ePreferredBitRate; /**< 96, 160, or 320 kbps; default: 320 */
  OMX_TIZONIA_AUDIO_SPOTIFYCONNECTIONTYPE
    eConnectionType; /**< Default: Connection type unknown */
...
typedef struct OMX_TIZONIA_AUDIO_PARAM_SPOTIFYPLAYLISTTYPE
{
  ...
  OMX_U8 cPlaylistOwner
    [OMX_MAX_STRINGNAME_SIZE]; /**< Spotify user that owns this list. If empty, the
...
{
  OMX_AUDIO_GmusicPlaylistTypeUnknown
  = 0,                                 /**< Playlist type unknown (Default). */
  ...
  OMX_AUDIO_GmusicPlaylistTypeKhronosExtensions
  = 0x6F000000, /**< Reserved region for introducing Khronos Standard Extensions */
  OMX_AUDIO_GmusicPlaylistTypeVendorStartUnused
  = 0x7F000000, /**< Reserved region for introducing Vendor Extensions */
...
{
  OMX_AUDIO_SoundCloudPlaylistTypeUnknown
  = 0, /**< Playlist type unknown (Default). */
  ...
  OMX_AUDIO_SoundCloudPlaylistTypeKhronosExtensions
  = 0x6F000000, /**< Reserved region for introducing Khronos Standard Extensions */
  OMX_AUDIO_SoundCloudPlaylistTypeVendorStartUnused
  = 0x7F000000, /**< Reserved region for introducing Vendor Extensions */
...
{
  OMX_AUDIO_TuneinPlaylistTypeUnknown
  = 0,                                /**< Playlist type unknown (Default). */
  ...
  OMX_AUDIO_TuneinPlaylistTypeKhronosExtensions
  = 0x6F000000, /**< Reserved region for introducing Khronos Standard Extensions */
  OMX_AUDIO_TuneinPlaylistTypeVendorStartUnused
  = 0x7F000000, /**< Reserved region for introducing Vendor Extensions */
...
typedef enum OMX_TIZONIA_AUDIO_TUNEINSEARCHTYPE
{
  ...
  OMX_AUDIO_TuneinSearchTypeKhronosExtensions
  = 0x6F000000, /**< Reserved region for introducing Khronos Standard Extensions */
  OMX_AUDIO_TuneinSearchTypeVendorStartUnused
  = 0x7F000000, /**< Reserved region for introducing Vendor Extensions */
...
typedef struct OMX_TIZONIA_AUDIO_PARAM_TUNEINPLAYLISTTYPE
{
  ...
  OMX_TIZONIA_AUDIO_TUNEINSEARCHTYPE
    eSearchType;     /**< Default: OMX_AUDIO_TuneinSearchTypeAll */
  OMX_BOOL bShuffle; /**< Default: OMX_FALSE */
  OMX_U8 cPlaylistName[OMX_MAX_STRINGNAME_SIZE];
...
{
  OMX_AUDIO_YoutubePlaylistTypeUnknown
  = 0, /**< Playlist type unknown (Default). */
  ...
  OMX_AUDIO_YoutubePlaylistTypeKhronosExtensions
  = 0x6F000000, /**< Reserved region for introducing Khronos Standard Extensions */
  OMX_AUDIO_YoutubePlaylistTypeVendorStartUnused
  = 0x7F000000, /**< Reserved region for introducing Vendor Extensions */
...
{
  OMX_AUDIO_DeezerPlaylistTypeUnknown
  = 0,                                  /**< Playlist type unknown (Default). */
  ...
  OMX_AUDIO_DeezerPlaylistTypeKhronosExtensions
  = 0x6F000000, /**< Reserved region for introducing Khronos Standard Extensions */
  OMX_AUDIO_DeezerPlaylistTypeVendorStartUnused
  = 0x7F000000, /**< Reserved region for introducing Vendor Extensions */
...
{
  OMX_AUDIO_PlexPlaylistTypeUnknown
  = 0, /**< Playlist type unknown (Default). */
  ...
  OMX_AUDIO_PlexPlaylistTypeKhronosExtensions
  = 0x6F000000, /**< Reserved region for introducing Khronos Standard Extensions */
  OMX_AUDIO_PlexPlaylistTypeVendorStartUnused
  = 0x7F000000, /**< Reserved region for introducing Vendor Extensions */
