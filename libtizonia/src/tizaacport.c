...
aacport_SetParameter_common (const void * ap_obj, OMX_HANDLETYPE ap_hdl,
...
{
    tiz_aacport_t * p_obj
        = super_ctor (typeOf (ap_obj, "tizaacport"), ap_obj, app);
...
static OMX_ERRORTYPE
aacport_GetParameter (const void * ap_obj, OMX_HANDLETYPE ap_hdl,
                      OMX_INDEXTYPE a_index, OMX_PTR ap_struct)
{
    ...
    default:
    {
        ...
        rc = super_GetParameter (typeOf (ap_obj, "tizaacport"), ap_obj,
...
static OMX_ERRORTYPE
aacport_SetParameter (const void * ap_obj, OMX_HANDLETYPE ap_hdl,
                      OMX_INDEXTYPE a_index, OMX_PTR ap_struct)
{
    tiz_aacport_t * p_obj = (tiz_aacport_t *) ap_obj;
    OMX_ERRORTYPE rc = OMX_ErrorNone;
    ...
    case OMX_IndexParamAudioAac:
    {
        ...
        if (OMX_ErrorNone == rc)
        {
            ...
            * a slave output port */
            ...
            {
                rc = aacport_SetParameter_common (ap_obj, ap_hdl, a_index,
                                                  ap_struct);
            }
        }
    }
    ...
    {
        /* Try the parent's indexes */
        rc = super_SetParameter (typeOf (ap_obj, "tizaacport"), ap_obj,
                                 ap_hdl, a_index, ap_struct);
    }
    };
...
static OMX_ERRORTYPE
aacport_SetParameter_internal (const void * ap_obj, OMX_HANDLETYPE ap_hdl,
                               OMX_INDEXTYPE a_index, OMX_PTR ap_struct)
{
    tiz_aacport_t * p_obj = (tiz_aacport_t *) ap_obj;
    OMX_ERRORTYPE rc = OMX_ErrorNone;
...
tiz_aacport_class_init (void * ap_tos, void * ap_hdl)
{
    ...
    void * tizaacport_class = factory_new
                              ...
                              (classOf (tizaudioport), "tizaacport_class", classOf (tizaudioport),
                               sizeof (tiz_aacport_class_t),
                               /* TIZ_CLASS_COMMENT: */
                               ap_tos, ap_hdl,
...
tiz_aacport_init (void * ap_tos, void * ap_hdl)
{
    ...
    void * tizaacport = factory_new
                        ...
                        (tizaacport_class, "tizaacport", tizaudioport, sizeof (tiz_aacport_t),
                         ...
                         dtor, aacport_dtor, tiz_api_GetParameter, aacport_GetParameter,
                         /* TIZ_CLASS_COMMENT: */
