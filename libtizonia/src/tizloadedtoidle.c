...
static OMX_ERRORTYPE
loadedtoidle_GetState (const void * ap_obj, OMX_HANDLETYPE ap_hdl,
...
static OMX_ERRORTYPE
loadedtoidle_UseBuffer (const void * ap_obj, OMX_HANDLETYPE ap_hdl,
...
static OMX_ERRORTYPE
loadedtoidle_EmptyThisBuffer (const void * ap_obj, OMX_HANDLETYPE ap_hdl,
...
static OMX_ERRORTYPE
loadedtoidle_FillThisBuffer (const void * ap_obj, OMX_HANDLETYPE ap_hdl,
                             OMX_BUFFERHEADERTYPE * ap_buf)
{
  return OMX_ErrorNotImplemented;
}
