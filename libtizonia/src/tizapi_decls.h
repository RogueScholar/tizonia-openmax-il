...
struct tiz_api_class
{
    ...
    (const void * ap_obj, OMX_HANDLETYPE ap_hdl, OMX_STRING ap_comp_name,
     OMX_VERSIONTYPE * ap_comp_ver, OMX_VERSIONTYPE * ap_spec_ver,
     OMX_UUIDTYPE * ap_comp_uuid);

    OMX_ERRORTYPE (*SendCommand)
    (const void * ap_obj, OMX_HANDLETYPE ap_hdl, OMX_COMMANDTYPE a_cmd,
    ...
    (const void * ap_obj, OMX_HANDLETYPE ap_hdl, OMX_STRING a_param_name,
     OMX_INDEXTYPE * ap_index_type);

    OMX_ERRORTYPE (*GetState)
    (const void * ap_obj, OMX_HANDLETYPE ap_hdl, OMX_STATETYPE * ap_state);

    OMX_ERRORTYPE (*ComponentTunnelRequest)
    (const void * ap_obj, OMX_HANDLETYPE ap_hdl, OMX_U32 a_port,
    ...
    (const void * ap_obj, OMX_HANDLETYPE ap_hdl, OMX_BUFFERHEADERTYPE ** pap_buf,
     OMX_U32 a_port_index, OMX_PTR ap_app_private, OMX_U32 a_size_bytes);

    OMX_ERRORTYPE (*FreeBuffer)
    (const void * ap_obj, OMX_HANDLETYPE ap_hdl, OMX_U32 a_port_index,
     OMX_BUFFERHEADERTYPE * ap_buf);

    OMX_ERRORTYPE (*EmptyThisBuffer)
    (const void * ap_obj, OMX_HANDLETYPE ap_hdl, OMX_BUFFERHEADERTYPE * ap_buf);

    OMX_ERRORTYPE (*FillThisBuffer)
    (const void * ap_obj, OMX_HANDLETYPE ap_hdl, OMX_BUFFERHEADERTYPE * ap_buf);

    OMX_ERRORTYPE (*SetCallbacks)
    (const void * ap_obj, OMX_HANDLETYPE ap_hdl, OMX_CALLBACKTYPE * ap_callbacks,
     OMX_PTR ap_app_data);

    OMX_ERRORTYPE (*ComponentDeInit) (const void * ap_obj, OMX_HANDLETYPE ap_hdl);
    ...
    (const void * ap_obj, OMX_HANDLETYPE ap_hdl, OMX_U8 * a_role,
     OMX_U32 a_index);
};

OMX_ERRORTYPE
super_GetComponentVersion (const void * class, const void * ap_obj,
...
super_AllocateBuffer (const void * a_class, const void * ap_obj,
                      OMX_HANDLETYPE ap_hdl, OMX_BUFFERHEADERTYPE ** pap_buf,
                      OMX_U32 a_port_index, OMX_PTR ap_app_private,
