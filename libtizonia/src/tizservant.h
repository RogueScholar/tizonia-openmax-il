 ...
 */
  ...
  OMX_ERRORTYPE
  tiz_srv_timer_watcher_restart (void * ap_obj,
                                 tiz_event_timer_t * ap_ev_timer);
  OMX_ERRORTYPE
  tiz_srv_timer_watcher_stop (void * ap_obj, tiz_event_timer_t * ap_ev_timer);
  void
  tiz_srv_timer_watcher_destroy (void * ap_obj,
                                 tiz_event_timer_t * ap_ev_timer);
  ...
  /* Event filters */
  OMX_ERRORTYPE
  tiz_srv_event_io (void * ap_obj, tiz_event_io_t * ap_ev_io,
  ...
  OMX_ERRORTYPE
  tiz_srv_stat_ready (void * ap_obj, tiz_event_stat_t * ap_ev_stat,
                      int a_events);
